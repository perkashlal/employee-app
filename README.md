...
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=perkashlal_employee-app&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=perkashlal_employee-app)

## Project details
This is a Java-based Employee Scheduling System using MongoDB. It maintains **100% test coverage** across all layers, including Controller, Repository, and Swing View.
